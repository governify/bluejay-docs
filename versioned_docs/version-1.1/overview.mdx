...
keywords:
  ...
  - Project auditing
  - Bluejay deployment
  - Bluejay service configuration
  - Bluejay Render service
  - Bluejay login credentials
  - Bluejay project list
  - Bluejay metrics calculation
  - Bluejay preferences
  - Bluejay dashboard login
---
...
<ReactPlayer playing controls url='https://www.youtube.com/watch?v=iAAeomXys0Y' width='100%' />

## Quick Tour

The main interaface is accesible from ui.bluejay.*[YourDomain]*. If you're deploying the infrastructure locally, the service (Render) is running on localhost:5100.
